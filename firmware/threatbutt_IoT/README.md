#Threatbutt IoT example
Sample project to drive the ssd1306 screen and interface with an ESP8266 to display threateny threats.
Code is janky and cut together as i put this together over a weekend.
It grabs stuff off the serial line, does some terrible parsing and displays it.
So please excuse the lack of testing, checks and overall security stuff - i just wanted to get it working.
Even better - look for the multiple flaws in the code! bug bounty payouts will be in 0805 resistors.
